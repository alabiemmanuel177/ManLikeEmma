            ...
            <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
              ...
              <div className="z-10 sm:col-span-6">
                ...
                <p className="mt-2 text-sm leading-normal">
                  Vulnerability Report System for InfoSec: Collaborated on
                  developing a system to track and manage security exceptions
                  for in-house projects. Implemented a process for recording
                  security exceptions on the application with proposed
                  solutions, enhancing the bank&apos;s information security
                  practices.
                </p>
                <ul
          ...
          <li className="mb-12">
            <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
              ...
              <div className="z-10 sm:col-span-6">
                ...
                <p className="mt-2 text-sm leading-normal">
                  Worked with React JS and Node Express, strengthening both
                  front-end and back-end development skills. Gained hands-on
                  experience in the fintech industry, developing a comprehensive
                  understanding of its challenges and requirements. Developed
                  non-technical skills such as communication, teamwork, and
                  problem-solving.
                </p>
            ...
            <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
              ...
              <div className="z-10 sm:col-span-6">
                ...
                <p className="mt-2 text-sm leading-normal">
                  ...
                  Python scripting, data extraction automation, UI/UX design,
                  and frontend development. Improved student registration for
                  the WASSCE by developing Python scripts using image comparison
                  and name matching algorithms, enhancing accuracy and
                  efficiency.
                </p>
                <ul
                  className="mt-2 flex flex-wrap"
            ...
            <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
              ...
              <div className="z-10 sm:col-span-6">
                ...
                <p className="mt-2 text-sm leading-normal">
                  ...
                  Performed troubleshooting, diagnostics, and resolved technical
                  problems to minimize downtime and enhance productivity.
                  Managed computer hardware installation, upgrades, and
                  maintenance, including software update Collaborated with
                  vendors to procure equipment, negotiate pricing, and ensure
                  timely delivery.
                </p>
              </div>
            </div>
